...
class CUB200(Dataset):
    ...
    def __init__(self, root='/data/zhoudw/FSCIL', train=True,
                 index_path=None, index=None, base_sess=None, autoaug=0):
    ...
    def _pre_operate(self, root):
        image_file = str(root + 'CUB_200_2011/images.txt')
        split_file = str(root + 'CUB_200_2011/train_test_split.txt')
        class_file = str(root + 'CUB_200_2011/image_class_labels.txt')
        ...
        if self.train:
            for k in train_idx:
                image_path = str(root + 'CUB_200_2011/images' + '/' + id2image[k])
